...
// const applicationMnager = TruffleContract(ApplicationArtifact).setProvider(getDefaultAccount());
// const steps = [{
//   title: 'Identifier',
// }, {
//   title: 'Metadata',
...
//             <Button type="primary" style = {{background: '#038935', border: '#038935'}} onClick={() => this.generateEthWallet()}>Generate elliptic curve key pair</Button>
//
//             {/*<Dropdown overlay={ecMenu}>*/}
//             {/*  <Button type="primary">*/}
//             {/*    Generate elliptic curve key pair*/}
...
//             <div>
//               <br />
//               <Alert style = {{background: '#c4f5e5', border: '#038935'}} message="You will be given private key and device configuration on the last step." type="info" showIcon />
//             </div> : null}
//         </div>
//
//       );
...
//             </FormItem>
//             <FormItem>
//               <Button type="primary" style = {{background: '#038935', border: '#038935'}} onClick={() => this.calculateMetadataHash()}>Generate</Button>
//             </FormItem>
//           </Form>
//         </div>
//       );
...
//           <br />
//           <br />
//           <Button type="primary" style = {{background: '#038935', border: '#038935'}} onClick={() => this.calculateFirmwareHash()}>Generate</Button>
//         </div>
//       );
//     }
//
...
//
//   async createDevice() {
//     const { identifier, metadataHash, firmwareHash, address, deviceClientName } = this.state;
//     try {
//       let instance = await DeviceManager;
...
//
//       // console.log(addHexPrefix(identifierToSave))
//       // console.log(addHexPrefix(metadataHash))
//       // console.log(addHexPrefix(firmwareHash))
//       // console.log(productID)
//       // console.log("productID...")
//       // console.log(typeof productID)
//       // console.log(productID)
//       // let result = await instance.createDevice(addHexPrefix(identifierToSave), metadataHash, firmwareHash, productID, deviceClientName, { from: getDefaultAccount() });
//
//       let result = await instance.createDevice(identifierToSave, metadataHash, firmwareHash, deviceClientName, { from: getDefaultAccount() });
//       console.log("try to print device ID?")
//       console.log(result)
//       this.watchForChanges(result.tx);
//       openNotificationWithIcon('info', 'Transaction sent', 'Once mined, your device will be registered.');
//       this.setState({
