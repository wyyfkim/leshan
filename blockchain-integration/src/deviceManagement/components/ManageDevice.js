...
class ManageDevice extends Component {
  ...
  async updateDeviceData() {
    try {
      ...
      allEvents.get((error, logs) => {
        ...
        let { identifier, metadataHash, firmwareHash, owner, productID } = this.state;
        this.setState({
  ...
  toggleEdit(property) {
    const { showEditFirmware, showEditIdentifier, showEditMetadata, showEditOwner, showEditProductID } = this.state;
  ...
  async saveData(property) {
    const { instance, deviceId, identifier, identifierNew, metadataHash, metadataHashNew, firmwareHash, firmwareHashNew, owner, ownerNew, productID, productIDNew } = this.state;
  ...
  render() {
    const { web3, loading, showError, owner, identifier, metadataHash, firmwareHash, productID, signatureCount, showEditFirmware, showEditIdentifier, showEditMetadata, showEditOwner, showEditProductID,  } = this.state;
