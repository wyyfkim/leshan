...
contract PassageMain is PassageModel{
    ...
    function addTemperaturAlert(
        bytes32 _productId,
        string _alertData
    ) public returns (string newAlert) {
    ...
    function getProductByDeviceClientName(string _deviceClientName) external view
    returns (bytes32 productId, string oldTempAlertStr, string oldLocAlertStr) {
        // Get the requested product from storage
        Product storage product = deviceClientNameToProductStruct[_deviceClientName];
        return (product.productId, product.temperatureAlerts, product.locationAlerts);
    }

    //    function getProductByDeviceClientName(string _deviceClientName) external view
    //    returns (bytes32 productId, string oldTempAlertStr) {
    //        // Get the requested product from storage
    //        Product storage product = deviceClientNameToProductStruct[_deviceClientName];
    //        return (product.productId, product.temperatureAlerts);
    //    }

    function getProductByIdExtra(bytes32 _productId, bytes32 specificVersionId) external view returns (string deviceClientName, string tempAlertStr, string locAlertStr) {
        Product storage product = productIdToProductStruct[_productId];

        return (product.deviceClientName, product.temperatureAlerts, product.locationAlerts);
    }

    //    function getProductByIdExtra(bytes32 _productId, bytes32 specificVersionId) external view returns (string deviceClientName,  string tempAlertStr) {
    //        Product storage product = productIdToProductStruct[_productId];
    //
    //        return (product.deviceClientName, product.temperatureAlerts);
    //    }
    function getProductById(bytes32 _productId, bytes32 specificVersionId) external view returns (string name, string description, string _latitude, string _longitude, uint versionCreationDate, bytes32[] versions) {
    ...
    function getProductCustomDataById(bytes32 _productId, bytes32 specificVersionId) external view returns (string customJsonData) {
