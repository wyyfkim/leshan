...
let message = 'Temperature too high';
...
let payload = {
  ...
  deviceIdentifier: deviceConfig.identifier,
  message,
  signature: signature,
  metadata: deviceConfig.metadata,
  metadataHash: deviceConfig.metadataHash,
...
request.post({ url: platformEndpoint, body: payload, json: true }, function (error, response, body) {
